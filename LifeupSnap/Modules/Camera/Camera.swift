...
internal class Camera: NSObject {
    ...
    fileprivate func setup() {
        ...
        focusImageView.image = LFSPhotoModel.shared.imageBundle(named: kIconCameraFocus, fromClass: Camera.self)
        focusImageView.isHidden = true
        
        exposureImageView = UIImageView(frame: CGRect(x: 0, y: 0, width: 80, height: 80))
        exposureImageView.image = LFSPhotoModel.shared.imageBundle(named: kIconCameraExposure, fromClass: Camera.self)
