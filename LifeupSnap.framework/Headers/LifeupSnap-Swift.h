...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LifeupSnap",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10LifeupSnap15GrowingTextView")
...
SWIFT_PROTOCOL("_TtP10LifeupSnap23GrowingTextViewDelegate_")
...
SWIFT_PROTOCOL("_TtP10LifeupSnap15LFSSnapDelegate_")
...
SWIFT_CLASS("_TtC10LifeupSnap21LFSSnapViewController")
@interface LFSSnapViewController : UIViewController
...
@interface LFSSnapViewController (SWIFT_EXTENSION(LifeupSnap)) <UIPickerViewDataSource, UIPickerViewDelegate>
...
@interface LFSSnapViewController (SWIFT_EXTENSION(LifeupSnap))
